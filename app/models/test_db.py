...
test_users = [
    User("John", "Smith", "johnsemail@friendscentral.org"),
    User("Jane", "Doe", "janesemail@friendscentral.org"),
    User("Lorem", "Ipsum", "latingibberish@friendscentral.org"),
    User("Lord", "Farquaad", "kingfromshrek@friendscentral.org"),
]
